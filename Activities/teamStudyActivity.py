...
name = [cow, goat, chicken]

def animalLimbs(cow, goat, chicken):
    if name == cow:
      print('A cow has 16 limbs')
    elif name == chicken:
      print('A chicken has 8 limbs')
    elif name == goat:
       print('A goat has 8 limbs')
    else:
...
# Keywords:
# parameter, string, function, input
