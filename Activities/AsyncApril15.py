...
def fruits():
    listoffruit: [apple, orange, apple, apple, banana, orange, apple, orange, mango]
    totalfruit = 9
    for amount in listoffruit:
        totalfruit += amount
        print(amount)
        print(f'this is the total fruit {totalfruit}')
        numberoffruit = len(listoffruit)
